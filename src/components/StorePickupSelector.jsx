                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0 w-full">
                                    ...
                                    <div className="min-w-0 pr-2">
                                        ...
                                        <div className="flex items-center gap-1.5 mt-0.5">
                                            <FaMapMarkerAlt className="text-slate-300 text-[9px] sm:text-[10px]" />
                                            <p className="text-[9px] sm:text-[10px] text-slate-400 font-bold truncate uppercase tracking-tighter">
                                ...
                                <div className="flex flex-row sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-2 w-full sm:w-auto pt-2 sm:pt-0 border-t sm:border-0 border-slate-100/50">
                                    <div className="px-3 py-1 sm:px-4 sm:py-1.5 rounded-full sm:rounded-2xl text-[9px] sm:text-[10px] font-black tracking-widest uppercase border bg-emerald-50 text-emerald-600 border-emerald-100">
                                        Gratuit
                                    </div>
